...
- Frames extracted at 12 fps to WebP (732 frames, ~17 MB) and scrubbed on a
  ...
  rewind.
- Original 180s score generated with Higgsfield (`sonilo_music`), played through
  Web Audio; each affirmation owns a 1/50th chapter of the song and scroll jumps
  seek the playhead to the active chapter.
